...
def train(cfg, seed):
    ...
    ## logger
    #logger.add(cfg.save_path+f'/train_seed_{seed}.log', filter=lambda x: "[train]" in x['message']) 
...
if __name__=='__main__':
    ...
    class Config:
        def __init__(self,seed):
            ...
            self.save_path         = f'./results/groupDRO-fairness/seed_{seed}/{self.local_time}'
